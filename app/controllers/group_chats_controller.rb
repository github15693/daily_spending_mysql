class GroupChatsController < ApplicationController
  ...
  # GET /group_chats
  # GET /group_chats.json
  def index
    @group_chats = GroupChat.all
  end

  # GET /group_chats/1
  # GET /group_chats/1.json
  def show
  end
  ...
  # POST /group_chats
  # POST /group_chats.json
  def create
    @group_chat = GroupChat.new(group_chat_params)

    respond_to do |format|
      if @group_chat.save
        format.html { redirect_to @group_chat, notice: 'Group chat was successfully created.' }
  ...
  # PATCH/PUT /group_chats/1
  # PATCH/PUT /group_chats/1.json
  def update
    respond_to do |format|
      if @group_chat.update(group_chat_params)
        format.html { redirect_to @group_chat, notice: 'Group chat was successfully updated.' }
  ...
  # DELETE /group_chats/1
  # DELETE /group_chats/1.json
  def destroy
    @group_chat.destroy
    respond_to do |format|
